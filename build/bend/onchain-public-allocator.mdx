...
<Note>
For the contract interface, see the [Public Allocator contract reference](/build/bend/contract-public-allocator).
</Note>

<Tip>
Read [Public Allocator](/bend/learn/public-allocator) for an overview of how it works and curator controls.
</Tip>
