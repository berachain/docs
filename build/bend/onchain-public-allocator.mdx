...
description: "Programmatically reallocate liquidity between Bend markets."
---
...
<Note>
To see more details, see the [Public Allocator contract reference](/build/bend/contract-public-allocator) section.
</Note>

<Tip>
Before getting started, we recommend reading the [Public Allocator Concepts](/bend/learn/public-allocator) page for a comprehensive overview of how the Public Allocator works and the benefits it provides.
</Tip>
