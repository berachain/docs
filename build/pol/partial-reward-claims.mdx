...
description: "Guide to using getPartialReward functionality for BGT splitting in Berachain Reward Vaults"
---
...
The `getPartialReward` function in [Reward Vaults](/build/getting-started/deployed-contracts) allows users to claim specific amounts of their earned BGT rewards instead of claiming all accumulated rewards at once. This enables more granular reward management and opens up new strategies for BGT utilization.

<Tip title="User Guide Available">
For end users wanting to understand BGT claiming options, see our [user guide on claiming BGT rewards](/general/tokens/bgt).
</Tip>
...
- [Reward Vault Contract](/build/getting-started/deployed-contracts) - Complete API documentation
- [`getPartialReward` function](/build/getting-started/deployed-contracts#getpartialreward) - Function reference
- [BGT Token Documentation](/build/getting-started/deployed-contracts) - Reward token details

**Integration Guides:**

- [Staking for Other Accounts](/build/pol/staking-for-other-accounts) - Complementary feature
- [Advanced PoL Integration](/build/pol/advanced-pol) - Non-ERC20 protocols

**User Guides:**

- [Claim BGT Rewards](/general/tokens/bgt) - End user claiming guide
