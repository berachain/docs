---
title: "Staking for Other Accounts"
description: "Guide to using stakeOnBehalf functionality in Berachain Reward Vaults"
---
...
The `stakeOnBehalf` function in [Reward Vaults](/build/getting-started/deployed-contracts) allows any account to stake tokens directly for another account without requiring delegation permissions. This feature enables new integration patterns and simplifies certain protocol workflows.

<Tip title="User Guide Available">
For end users wanting to understand how protocols can claim BGT on their behalf, see the [BGT claiming guide](/general/tokens/bgt#protocol-claiming).
</Tip>
...
- [`stakeOnBehalf` function](/build/getting-started/deployed-contracts#stakeonbehalf) - Function reference

**Integration Guides:**

- [Advanced PoL Integration](/build/pol/advanced-pol) - Non-ERC20 protocols
- [PoL Integration Quickstart](/build/getting-started/overview) - Getting started
- [Partial Reward Claims](/build/pol/partial-reward-claims) - Complementary feature

**User Guides:**

- [BGT Claiming Guide](/general/tokens/bgt#protocol-claiming) - End user perspective on protocol claiming
