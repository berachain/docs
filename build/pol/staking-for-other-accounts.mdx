...
The `stakeOnBehalf` function in [Reward Vaults](/general/proof-of-liquidity/reward-vaults) allows any account to stake tokens directly for another account without requiring delegation permissions. This feature enables new integration patterns and simplifies certain protocol workflows.
...
- [Reward Vaults](/general/proof-of-liquidity/reward-vaults) - Reward Vault overview and reference

**Integration Guides:**

- [Advanced PoL Integration](/build/pol/advanced-pol) - Non-ERC20 protocols
- [PoL Integration Quickstart](/build/pol/integration-basics) - Getting started
