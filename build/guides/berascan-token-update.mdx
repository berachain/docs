---
title: "Berascan Token Update Guide"
description: "Learn how to update token information on Berascan, the Berachain block explorer"
head:
  - - meta
    - property: og:title
...
![Berascan Owner Verification Process](/images/build/berascan-owner-verification.png)
...
![Berascan Verification Submission](/images/build/berascan-verification-submission.png)
...
![Berascan Basic Information Form](/images/build/berascan-basic-information-form.png)

- **Social Profiles**: Links to official social media pages (GitHub, Telegram, Discord, etc.)

![Berascan Social Profiles Form](/images/build/berascan-social-profiles-form.png)
