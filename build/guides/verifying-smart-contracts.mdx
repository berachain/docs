...
<Tip>
To deploy a contract first, see [Developer tools](/build/getting-started/developer-tools) for setup with Hardhat, Foundry, and other tooling.
</Tip>
...
<Info>
For full plugin behavior and options, see the [Remix contract verification documentation](https://remix-ide.readthedocs.io/en/latest/contract_verification.html).
</Info>
