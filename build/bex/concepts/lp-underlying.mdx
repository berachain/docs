...
description: "Query underlying tokens for a BEX LP token and your pool share."
---
...
## Example: Querying BERA/BUSD pool

Let's say you want to know your underlying BERA and BUSD balances for a BERA/BUSD pool:

| Step | Action | Result |
| --- | --- | --- |
| 1 | Query BEX | tokens = \[BERA, BUSD\], balances = \[1000 BERA, 10000 BUSD\] |
...
| 6 | Calculate underlying | yourBUSD = 10000 \* 0.1 = 1000 BUSD |

In this example, your 100 LP tokens represent 100 BERA and 1000 BUSD.