---
title: "Valuing LP Tokens"
description: "Calculate BEX LP token value: informational and on-chain methods."
---
...
Suppose a \$BERA/\$BUSD pool contains the following:

| Token | Balance | Price (USD) | Value (USD) |
| --- | --- | --- | --- |
| \$BERA | 1,000 | \$10 | \$10,000 |
| \$BUSD | 10,000 | \$1 | \$10,000 |
| **Total Pool Value** |  |  | **\$20,000** |
| **LP Token Supply** | **1,000** |  |  |

- **Pool Value:** 1000 \$BERA $\times$ 10 USD \+ 10000 \$BUSD $\times$ 1 USD = 20000 USD
