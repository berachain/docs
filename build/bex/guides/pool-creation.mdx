...
In this example, we'll create a 50/50 BUSD-WBTC weighted pool using [Ethers.js](https://docs.ethers.org/v6/). Following pool creation, the pool will be joined with 1 BUSD and 0.0001 WBTC.
...
// Pool parameters
const poolName = "BUSD-WBTC-WEIGHTED";
const poolSymbol = "50BUSD-50WBTC";
const createPoolTokens = [busdToken.address, wbtcToken.address].sort((a, b) =>
...
const amountsIn = [
  ethers.parseUnits("1", 18), // 1 BUSD (18 decimals)
