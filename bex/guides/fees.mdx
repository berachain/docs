---
title: "Fees"
description: "How trading fees are split between LPs and the protocol and compounded in pools."
---
...
Trading fees in BEX are split 50/50 between LPs and the protocol. Protocol fees are collected in the `ProtocolFeesCollector` contract.
