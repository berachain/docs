...
The core functionality of BEX is to allow you to exchange one type of token for another. If liquidity exists for a given pair in the DEX contract, you can swap between tokens. The BEX web app provides an interface for general-purpose swaps.
