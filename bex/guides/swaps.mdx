...
<Frame>
  <img src="/images/bex-swaps-modal-route.png" alt="BEX swap modal showing the selected token pair and swap route" />
</Frame>
...
<Frame>
  <img src="/images/bex-swaps-multi-hop-route.png" alt="BEX swap modal showing a multi-hop route with intermediate tokens" />
</Frame>
...
<Frame>
  <img src="/images/bex-swaps-slippage-settings.png" alt="BEX swap slippage settings panel for configuring maximum slippage tolerance" />
</Frame>
