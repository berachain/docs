...
description: "How DEXs and AMMs work and how BEX uses Balancer V2-style architecture."
---
...
- **Flexible pool types**: BEX supports multiple pool types optimized for different trading scenarios:
  - [**Weighted pools**](/bex/learn/weighted-pools): Support 2-8 tokens with customizable weights (e.g., 80/20 BUSD/WETH or 33/33/33 BUSD/WETH/WBTC), unlike fixed 50/50 pairs
