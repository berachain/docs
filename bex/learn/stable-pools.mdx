---
title: "Stable Pools"
description: "Pools for stablecoins and correlated assets; composability and amplification."
---
...
- There is a stable pool with `[BUSD, USDC, and DAI]`
- You create a [weighted pool](/bex/learn/weighted-pools) pairing `WETH` against the `[BUSD, USDC, and DAI]` pool
