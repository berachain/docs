...
Users participate by staking eligible assets in Reward Vaults, or by depositing \$BERA into the [\$sWBERA](/general/tokens/swbera) (Staked WBERA) Staking Vault.
...
<Steps>
  <Step title="Stake BERA">
    Validators stake \$BERA to enter the active set. Additional stakers can increase a validator’s stake directly or via [Staking Pools](/nodes/staking-pools/overview), impacting that validator’s block-production probability.
  </Step>
  ...
  <Step title="Allocate WBERA">
    Each proposed block creates a fixed \$WBERA Reward Vault emission. The Distributor applies any active [Dedicated Emission Stream](/general/proof-of-liquidity/block-rewards#dedicated-emission-stream-des) carve-out, then allocates the remainder through validator reward allocation.
  </Step>
...
<Info>
  BGT was deprecated on July 8, 2026. See the full post here: [https://x.com/berachain/status/2074901414149771549?s=20](https://x.com/berachain/status/2074901414149771549?s=20)
</Info>
