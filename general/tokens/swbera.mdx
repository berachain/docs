...
\$sWBERA tokens are issued when you stake BERA or WBERA in the Staking Vault. For details on how staking BERA yields \$sWBERA, see [Stake BERA for sWBERA](/general/tokens/bera#stake-bera-for-swbera).
