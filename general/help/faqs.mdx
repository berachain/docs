...
<AccordionGroup>
  ...
  <Accordion title="What is $BUSD?">
    <Info>
      `$BUSD` was previously known as `$BUSD`. As of August 19, 2026 its token name and symbol have been changed to Bera USD and BUSD respectively. The contract address remains the same.
    </Info>
