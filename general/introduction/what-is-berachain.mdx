...
Berachain's execution runtime environment is identical to the Ethereum Virtual Machine (EVM) as seen on Ethereum Mainnet. Berachain uses very lightly modified forks of popular execution clients like Geth and Reth to handle executing smart contracts. Berachain supports all the usual tooling that is familiar to EVM developers.
