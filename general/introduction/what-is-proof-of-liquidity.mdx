...
flowchart TB
    Emissions["📦 Emissions<br/>WBERA per block"]:::pill

    BERA["🐻 BERA strengthens<br/>more business funded"]:::pill
    POL(["✨ Proof of<br/>Liquidity"]):::center
    Business["☀️ Business grow<br/>build with growth capital"]:::pill

    Revenue["🍇 Revenue shared<br/>directly or via<br/>the incentive market"]:::pill

    %% visible clockwise cycle: down the right, up the left
    Emissions --> Business
    Business --> Revenue
    Revenue --> BERA
    BERA --> Emissions

    %% invisible scaffolding: compress the 4-cycle into 3 ranks
    Emissions ~~~ BERA
    Emissions ~~~ POL
    POL ~~~ Revenue
