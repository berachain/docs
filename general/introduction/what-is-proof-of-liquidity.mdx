...
%%{init: {'flowchart': {'curve': 'cardinal', 'nodeSpacing': 90, 'rankSpacing': 90}}}%%
flowchart TB
    Emissions["📦 Emissions<br/><small>WBERA per block</small>"]:::pill

    BERA["🐻 BERA strengthens<br/><small>more business funded</small>"]:::pill
    POL((("✨ Proof of<br/><small>Liquidity</small>"))):::center
    Business["☀️ Business grow<br/><small>build with growth capital</small>"]:::pill

    Revenue["🍇 Revenue shared<br/><small>directly or via the incentive market</small>"]:::pill
    ...
    classDef pill fill:#fdf0e6,stroke:#fdf0e6,color:#2a2a2a
    classDef center fill:none,stroke:none,color:#e8622c,font-weight:bold
    class Emissions,BERA,Business,Revenue pill
    class POL center

    linkStyle 0,1,2,3 stroke:#e8622c,stroke-width:2px
