...
description: "Just-in-time liquidity for Bend markets via the Public Allocator"
---
...
<Note>
Public Allocator (PA) requires that the Vault Owner whitelist the PA contract in order for it to work.
</Note>
