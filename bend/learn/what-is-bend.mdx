...
<Frame>
  ![Bend protocol overview](/images/bend/overview.png)
</Frame>
...
- **Lending**: Deposit assets to earn interest and PoL rewards
...
- **Lend**: [Deposit & Withdraw](/bend/guides/deposit-withdraw) — supply `$BUSD` to a vault and optionally stake for PoL rewards.
- **Borrow**: [Borrow & Repay](/bend/guides/borrow-repay) — supply collateral and borrow `$BUSD`; monitor LTV to avoid liquidation.
