...
description: "How the AdaptiveCurveIRM determines supply and borrow rates."
---
...
Currently, the only IRM available for Bend markets is the [AdaptiveCurveIRM](/bend/learn/interest-rates#the-adaptivecurveirm). This model stands apart from traditional lending pool IRMs in two main ways:
