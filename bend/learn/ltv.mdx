...
description: "Loan-to-value ratios, health factor, and liquidation thresholds."
---
...
Here is a concrete example of calculating LTV and Health Factor for a position on Bend:

**Given values (with assumptions):**

- Borrowed amount: 150 $HONEY (150 x 10^18 base units — 18 decimals)
- Collateral amount: 100 $WBERA (100 x 10^18 base units — 18 decimals)
- Oracle price: 3 $HONEY per $WBERA (value = 3 x 10^18)
- Oracle price scale: 10^18
- LLTV: 86% (0.86 x 10^18 = 860,000,000,000,000,000 WAD)

### Step 1 - Calculate the collateral value in loan token units

The collateral value is 300 $HONEY, meaning the collateral is worth 300 $HONEY.
...
If you'd like to learn more about the oracles, see [Bend Oracle](/bend/learn/oracle).
