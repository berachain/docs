...
Trung tâm quy trình mint `$HONEY` là contract [`HoneyFactory`](https://berascan.com/address/0xA4aFef880F5cE1f63c9fb48F661E27F8B4216401) (cùng địa chỉ trên mainnet và Bepolia). Contract này đóng vai trò hub trung tâm, kết nối tất cả vault `$HONEY` và chịu trách nhiệm mint token `$HONEY` mới.
