---
title: "Vault"
description: "Vault.sol serves as the entrypoint for all trading and liquidity operations"
---

> [0x4Be03f781C497A489E3cB0287833452cA9B9E80B](https://berascan.com/address/0x4Be03f781C497A489E3cB0287833452cA9B9E80B) | [ABI JSON](https://github.com/berachain/doc-abis/blob/main/bex/IVault.abi.json)
...
Pools can only interact with tokens they have registered. You join a Pool by transferring registered tokens,
...
*Called by you to join a Pool, which transfers tokens from `sender` into the Pool's balance. This will
...
their own custom logic. This typically requires additional information from you (such as the expected number
...
*Called by you to exit a Pool, which transfers tokens from the Pool's balance to `recipient`. This will
...
`minAmountsOut` is the minimum amount of tokens you expect to get out of the Pool, for each token in the
