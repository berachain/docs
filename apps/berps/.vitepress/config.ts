...
export default defineConfig({
  title: `${constants.websites.docsBerps.name}`,
  description: `${constants.websites.docsBerps.description}`,
  srcDir: "content",
  cleanUrls: true,
  head: [
    ...
    [
      "meta",
      { name: "og:site_name", content: `${constants.websites.docsBerps.name}` },
    ],
    [
      "meta",
      {
        name: "og:image",
        content: `${constants.websites.docsBerps.url}/previewDocs.jpg`,
      },
    ],
    [
      "script",
  ...
  sitemap: {
    hostname: `${constants.websites.docsBerps.url}`,
  },
  themeConfig: {
