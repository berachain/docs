...
Singleton contracts are deployed once and shared across all staking pools. These are the contracts you interact with directly to deploy and manage your staking pool.
