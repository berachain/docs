...
> <small><a target="_blank" :href="config.websites.berascan.url + 'address/' + config.contracts.pol.beaconDeposit.address.berachainMainnet">{{config.contracts.pol.beaconDeposit.address.berachainMainnet}}</a><span v-if="config.contracts.pol.beaconDeposit.abi && config.contracts.pol.beaconDeposit.abi.length > 0">&nbsp;|&nbsp;<a target="_blank" :href="config.contracts.pol.beaconDeposit.abi">ABI JSON</a></span></small>
