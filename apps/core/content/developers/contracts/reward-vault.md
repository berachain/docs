...
*This contract is taken from the stable and tested:
...
*This acts as both a maximum and a target rate. When the calculated reward rate exceeds this value,
...
*This rate acts as both a maximum and a target. When rewards exceed this rate, the duration is
