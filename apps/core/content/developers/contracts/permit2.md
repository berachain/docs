...
> <small><a target="_blank" :href="config.mainnet.dapps.berascan.url + 'address/' + config.contracts.permit2.address">{{config.contracts.permit2.address}}</a><span v-if="config.contracts.permit2.abi">&nbsp;|&nbsp;<a target="_blank" :href="config.contracts.permit2.abi">ABI JSON</a></span></small>
