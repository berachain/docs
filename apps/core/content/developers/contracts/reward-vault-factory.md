...
> <small><a target="_blank" :href="config.websites.berascan.url + 'address/' + config.contracts.pol.rewardVaultFactory.address.berachainMainnet">{{config.contracts.pol.rewardVaultFactory.address.berachainMainnet}}</a><span v-if="config.contracts.pol.rewardVaultFactory.abi && config.contracts.pol.rewardVaultFactory.abi.length > 0">&nbsp;|&nbsp;<a target="_blank" :href="config.contracts.pol.rewardVaultFactory.abi">ABI JSON</a></span></small>
