...
An RPC node can become a validator node by joining the [Active Set](#validator-active-set) through interaction with the [BeaconDeposit](/build/getting-started/deployed-contracts) contract by
meeting the \$BERA [stake requirements](#validator-active-set). To learn about the economics of becoming a validator,
