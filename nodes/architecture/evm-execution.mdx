...
The following execution client is recommended to go with **[Beacon Kit v1.3.7](https://github.com/berachain/beacon-kit/releases/tag/v1.3.7)**.

| Language | Required Version (Mainnet & Bepolia)                                           |
| -------- | ------------------------------------------------------------------------------ |
| Rust     | [Bera-Reth v1.3.2](https://github.com/berachain/bera-reth/releases/tag/v1.3.2) |
