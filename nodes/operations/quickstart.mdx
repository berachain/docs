...
|------|-------------|---------|
| `--network`, `-n` | `mainnet` or `testnet` | `mainnet` |
| `--type`, `-t` | `pruned` or `archive` | `pruned` |
| `--help`, `-h` | Show help message | — |

<Info>
  Community-operated snapshot mirrors are listed in
  [Awesome Berachain Validators](https://github.com/chuck-bear/awesome-berachain-validators).
  These are a good alternative if you prefer a different download source.
</Info>
