...
description: "Validator and developer changes from the Osaka1 upgrade on Berachain Mainnet & Bepolia."
---
...
Osaka1 is carried in the built-in `--chain bepolia` and `--chain mainnet` presets shipped with Bera-Reth v1.4.3. The Berachain genesis `berachain.osaka1` block for Mainnet and Bepolia are:
