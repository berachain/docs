---
title: "Monitoring"
description: "Set up Prometheus and Grafana to monitor BeaconKit and execution layer metrics, endpoints, and sample dashboards."
---
...
BeaconKit must have the Prometheus instrumentation enabled. To do this, revise the configuration:
...
This enables the BeaconKit client to listen on port 9107. As a precaution, ensure this port can't be reached by the public with a firewall or by scoping the address to your administrative network instead of `0.0.0.0`.
...
<Frame>
  <img
    src="/images/nodes/monitoring-dashboard-1.png"
    alt="Berachain Grafana monitoring dashboard showing node metrics"
  />
</Frame>

<Frame>
  <img
    src="/images/nodes/monitoring-dashboard-2.png"
    alt="Berachain Grafana monitoring dashboard showing additional metrics"
  />
</Frame>
