...
**Open ports.** Two ports are required to be open: the Beacon Kit P2P port (26656) and the Bera-Reth P2P port (30303). These should be open to TCP and UDP traffic. It is not recommended to leave port 8545 and 8546 (JsonRPC and websocket RPC) open to the public.
