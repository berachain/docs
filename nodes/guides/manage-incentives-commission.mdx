...
<Frame>
  <img
    src="/images/nodes/berachain-change-validator-commission-rate-process.png"
    alt="Berachain change validator commission rate process flow"
  />
</Frame>
...
<Info>
  This can only be done after the **`commissionChangeDelay`** has passed, and this **can be executed
  by anyone**.
</Info>
