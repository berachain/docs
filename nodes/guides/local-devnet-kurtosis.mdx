...
<Info>
  The packaged Kurtosis EL genesis template already includes the `depositContractAddress` field that
  Fusaka networks require. If you swap in a custom EL genesis, add `"depositContractAddress":
  "0x4242424242424242424242424242424242424242"` under `config`.
</Info>
...
<Tip>If you encounter issues, please see [Debugging Issues](#debugging-issues) below.</Tip>
