...
<Info>
  The packaged Berachain genesis templates already include the EL `depositContractAddress` field
  under `config` that Fusaka networks require. If you swap in a custom EL genesis, add
  `"depositContractAddress": "0x4242424242424242424242424242424242424242"` under `config`.
</Info>
