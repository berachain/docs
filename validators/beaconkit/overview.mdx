...
For running a node, see [BeaconKit Consensus Layer](/validators/architecture/beaconkit-consensus) in Architecture. For the official implementation, see the [BeaconKit GitHub repository](https://github.com/berachain/beacon-kit).
