...
This guide results in a simple deployment of a few validators and one RPC. If you want more control over the network, and additional services such as block explorers and PoL backends, refer to [Local Devnet with Kurtosis](/validators/guides/local-devnet-kurtosis).

## Requirements

Before starting, ensure that you have the following installed on your computer:

- Have read and understood the [validator activation process](/validators/guides/become-a-validator)
