...
Check that you are running a supported version of your [execution client](/validators/architecture/evm-execution). Note that Berachain doesn't _always_ support the latest version of a given client.
