...
`$HONEY` 铸造流程的核心是 [`HoneyFactory`](https://beratrail.io/address/0xA4aFef880F5cE1f63c9fb48F661E27F8B4216401) 合约（主网和 Bepolia 地址相同）。该合约作为中心枢纽，连接所有 `$HONEY` 金库并负责铸造新 `$HONEY` 代币。
