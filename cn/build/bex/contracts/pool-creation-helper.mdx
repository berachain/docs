...
description: "Helper contract to create and join pools in a single transaction"
---

> [0x55dccE8165C88aAd4403a15A9cE3A8E244657dD2](https://berascan.com/address/0x55dccE8165C88aAd4403a15A9cE3A8E244657dD2) | [ABI JSON](https://github.com/berachain/doc-abis/blob/main/bex/IPoolCreationHelper.abi.json)
...
> Note: This contract must be approved as a relayer by the pool creator inside the [vault contract](/build/bex/contracts/vault) to join pools (using `setRelayerApproval`).

## Functions

### createAndJoinWeightedPool

_Creates a weighted pool and joins it in a single transaction. Allows you to create a WBERA weighted pool and join it with either WBERA or BERA._
...
_Creates a stable pool and joins it in a single transaction. Allows you to create a WBERA stable pool and join it with either WBERA or BERA._
