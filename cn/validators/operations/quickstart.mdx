...
description: "Set up and run a Berachain node with a consensus client and execution client"
---
...
See [EVM Execution Clients](/validators/architecture/evm-execution) for recommended versions.
...
- **[Production Checklist](/validators/operations/production-checklist)** — Best practices for running nodes in production
- **[Monitoring](/validators/operations/monitoring)** — Set up monitoring and alerts for your node
- **[Become a Validator](/validators/guides/become-a-validator)** — Guide to becoming a validator on Berachain
